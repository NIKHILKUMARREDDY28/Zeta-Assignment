# Zen-Bank Project Documentation

## Task 1: Dispute Management System
...
## Task 2: AI-Powered Customer Portal MVP
...
3. **Rate Limiting**(AS PART OF TASK 4)
   - Prevents API abuse
